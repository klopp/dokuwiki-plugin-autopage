...
class action_plugin_autons extends DokuWiki_Action_Plugin {
    ...
    {
       $controller->register_hook('IO_NAMESPACE_CREATED', 'AFTER', $this, 'autons_handle');
    }
    ...
    public function autons_handle(Doku_Event &$event, $param) 
    {
        global $conf;
        global $INFO;
